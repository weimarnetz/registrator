...
public class RestMvcIT {
    ...
    public void testUpdateNodeNumberInvalidNetwork() {
        webTestClient.put().uri("/NOT_OUR_NETWORK/knoten/2?mac=02caffeebabe&pass=test123").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isNotFound();
    }
    ...
    public void testUpdateNodeNumberInvalidPass() {
        int nodenumber = webTestClient.post().uri("/ffweimar/knoten?mac=05caffeebabe&pass=54321").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isCreated()
        ...
        webTestClient.put().uri("/ffweimar/knoten/" + nodenumber + "?mac=05caffeebabe&pass=54322").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isOk();
    }
    ...
    public void testUpdateNodeNumberWrongMac() {
        int nodenumber = webTestClient.post().uri("/ffweimar/knoten?mac=07caffeebabe&pass=54321").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isCreated()
                .returnResult(NodeResponse.class)
        ...
        webTestClient.put().uri("/ffweimar/knoten/" + nodenumber + "?mac=07caffeebabf&pass=54322").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isUnauthorized();
    ...
    public void testUpdatePassword() {
        webTestClient.put().uri("/ffweimar/updatepassword/2?mac=02caffeebabe&oldPass=test&newPass=test123").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody(NodeResponse.class)
    ...
    public void testUpdatePasswordWrongOldPassword() {
        webTestClient.put().uri("/ffweimar/updatepassword/2?mac=02caffeebabe&oldPass=test333&newPass=test123").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody(NodeResponse.class);
    ...
    public void testUpdatePasswordInvalidMac() {
        webTestClient.put().uri("/ffweimar/updatepassword/2?mac=caffeebabe&oldPass=test&newPass=test123").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isBadRequest();
    }
    ...
    public void testUpdatePasswordWrongMac() {
        webTestClient.put().uri("/ffweimar/updatepassword/2?mac=02caffeebabf&oldPass=test&newPass=test123").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isUnauthorized();
    }
    ...
    public void testUpdatePasswordInvalidNodeNumber() {
        webTestClient.put().uri("/ffweimar/updatepassword/3?mac=02caffeebabe&oldPass=test&newPass=test123").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isUnauthorized();
    }
    ...
    public void testUpdateNodeNumberInvalidNodenumber() {
        int nodeNumber = webTestClient.post().uri("/ffweimar/knoten?mac=06caffeebabe&pass=54321").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isCreated()
                .returnResult(NodeResponse.class).getResponseBody().blockFirst().getNode().getNumber();

        webTestClient.put().uri("/ffweimar/knoten/" + nodeNumber + 23 + "?mac=06caffeebabe&pass=54321").accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isUnauthorized();
    }
