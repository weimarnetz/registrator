...
public class RestMvcTest {
    ...
    public void testAddNewNodeNumber() {
        RestAssured.given(this.spec).port(port)
                ...
                .then().assertThat().statusCode(is(201)).and().body(matchesJsonSchemaInClasspath(NODE_RESPONSE_SCHEMA_JSON));
    }
